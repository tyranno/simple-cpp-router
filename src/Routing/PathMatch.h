...
class PathMatch final {
 public:
   ...
   * @param variable name
   * @returns variable
   * @throws NoSuchElementException if path template doesn't contain variable
   * with given name
  ...
  /**
   * @brief Get dynmaic parameter data (map<string, string>)
   * @returns parameter map
   * @details example: for path template [/path/to/:var] and actual
   * path [/path/to/123] result will be 'param["var"]=123'
   */
